...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.freeteratec.mepster.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.freeteratec.mepster.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, org.freeteratec.mepster.domain.User.class.getName());
            createCache(cm, org.freeteratec.mepster.domain.Authority.class.getName());
            createCache(cm, org.freeteratec.mepster.domain.User.class.getName() + ".authorities");
            createCache(cm, org.freeteratec.mepster.domain.Organization.class.getName());
            ...
            createCache(cm, org.freeteratec.mepster.domain.Organization.class.getName() + ".subOrganizations");
