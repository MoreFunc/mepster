...
public class MonthlyAvailability implements Serializable {
    ...
    public MonthlyAvailability id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public MonthlyAvailability yearmonth(LocalDate yearmonth) {
    ...
    public MonthlyAvailability percent(Integer percent) {
    ...
    public MonthlyAvailability isActive(Boolean isActive) {
    ...
    public MonthlyAvailability person(Person person) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MonthlyAvailability)) {
            return false;
        }
        return id != null && id.equals(((MonthlyAvailability) o).id);
    }
