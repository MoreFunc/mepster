...
describe('Service Tests', () => {
  describe('ProjectPosition Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ProjectPosition', async () => {
        const returnedFromService = Object.assign(
          {
            id: 123,
            start: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not create a ProjectPosition', async () => {
      ...
      it('should update a ProjectPosition', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB',
            description: 'BBBBBB',
      ...
      it('should not update a ProjectPosition', async () => {
      ...
      it('should not partial update a ProjectPosition', async () => {
      ...
      it('should return a list of ProjectPosition', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB',
            description: 'BBBBBB',
      ...
      it('should not return a list of ProjectPosition', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a ProjectPosition', async () => {
      ...
      it('should not delete a ProjectPosition', async () => {
